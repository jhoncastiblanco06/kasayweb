...
<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <div class="container mx-auto px-4 lg:px-16 py-8">
        ...
        <nav class="text-sm text-gray-500 mb-8 flex items-center space-x-2">
            <a href="/kasayweb/index.php" class="hover:text-cyan-600 transition"><i class="fa-solid fa-house"></i> Inicio</a>
            <span><i class="fa-solid fa-angle-right text-xs"></i></span>
            <a href="/kasayweb/src/views/blog-index.php" class="hover:text-cyan-600 transition">Blog</a>
            <span><i class="fa-solid fa-angle-right text-xs"></i></span>
