...
<head>
    ...
    <style>
        html {
            ...
            /* Habilita la animación de desplazamiento suave para toda la página */
        }
        ...
        /* Aplica la fuente Lora a los elementos con la clase font-lora */
        .gradient-bg-hero {
            background: linear-gradient(120deg, rgba(0, 124, 240, 0.9), rgba(0, 154, 186, 0.8));
        }

        /* Fondo degradado personalizado para la sección hero */
        .card-hover-effect {
            transition: transform 0.3s ease-in-out, box-shadow 0.3s ease-in-out;
        }

        /* Efecto de transición para las tarjetas al pasar el mouse */
        .card-hover-effect:hover {
            transform: translateY(-5px);
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1);
        }

        /* Eleva y agrega sombra a la tarjeta al hacer hover */
    </style>
</head>
