...
//Inicializar el mapa
var map = L.map("map").setView([4.651735, -74.094], 15); // Inicializa el mapa centrado en Bogotá
...
marker
  .bindPopup(
    '<b><a href= "https://maps.app.goo.gl/4QZmSTfJhFXDdLDq9" target="_blank">Kasay Ingeniería S.A.S</a></b><br>Carrera 59 #44a-30, Bogotá',
    {
      autoClose: false,
      closeOnClick: false,
    },
